...
public class NavKaoController {
	...
	private String REDIRECT_URL = "http://localhost:8090/navJoin.do";
...
//			    result = accessTokenNode.asText();
//			    System.out.println("카카오 AccessToken result ::" + result);
//			} else {
//			    System.out.println("카카오 API 응답에서 access_token을 찾을 수 없습니다.");
//			}
		} catch (Exception e) { e.printStackTrace();	}		
		return result;		
	}
