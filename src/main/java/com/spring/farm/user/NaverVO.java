...
//	private String clientId = "dJ684BcMbtE3EAbNCUpY"; // 네이버 클라이언트 아이디 값
	private String clientId = "eJNwbIHzdbjd2h0dMCxi"; // 네이버 클라이언트 아이디 값
//    private String clientSecret = "fIiPneAI59"; //네이버 클라이언트 시크릿값
    private String clientSecret = "4KftgswX1P"; //네이버 클라이언트 시크릿값
    private String callback_url = "http://localhost:8090/navJoin.do"; // 네이버 리다이렉트url
