		...
		<div class="inner">
			...
			<div class="in login_w">
				<form action="login.do" method="post">
					<ul class="form">
						<li><input type="text" name="user_id" placeholder="아 이 디 " value="snrnsrk" required></li>
						<li class="pw"><input type="password" name="user_pw" value="snrnsrk1025" placeholder="비밀번호" required></li>
					</ul>
					<div>
