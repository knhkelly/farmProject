...
<%-- 					<c:if test="${user_id == review.review_id || user_id == 'farmadmin'}">                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           --%>
						<button class="modibtn" style="width:80px;" type="submit" id="ReviewReply">댓글쓰기</button>
<%-- 						</c:if> --%>
					<button class="modibtn" type="button" id="adminDeleteReview" onclick="location.href='/adminDeleteReview.do?review_num=${review.review_num}'">글삭제</button>
					<button class="modibtn"type="button" id="ReviewListget" onclick="location.href='/adminReview.do'">글목록</button>
				</div>
		</form>
	</div>
</div>
