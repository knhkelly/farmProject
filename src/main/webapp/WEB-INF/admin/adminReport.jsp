...
<div class="reptDtdiv">
	...
	<div class="container-fluid">
    	...
    	<div class="all">
      		...
      		<textarea class="form-control innm" rows="10"  name="report_content" style="background-color: white; resize:none; " readonly>${report.report_content}</textarea>      
    	</div>  
    	<div class="all">
					<div class="spandiv">
      	...
      	<div class="all">
      		...
      		<textarea class="form-control innm" rows="5" name="report_reason" style="background-color: white;" readonly>${report.report_reason}</textarea>      
    	</div>
    	

   
    	<div id="footer">
	  		<button type="button" class="btn btn-primary" onclick="deleteReport()">원본 글 삭제</button>
<%-- 		  	<button type="button" class="btn btn-primary" onclick="QNAinsert('${user_id}')">신고 글 삭제</button> --%>
	  		<button type="button" class="btn btn-primary" onclick="getReportList()">글목록</button>
		</div>
  		</form>  
	</div>
</div>
