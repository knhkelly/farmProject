...
<div class="container-fluid">
  ...
  <input type="hidden" name="review_num" value="${review.review_num}">
    <div class="input-group mb-3" style="margin-bottom: 0.5rem !important;" >
      ...
      <input type="text" class="form-control innm" name="review_title" value="${review.review_title}" style="background-color: white;">      
    </div>
    ...
    <div class="input-group mb-3" style="margin-bottom: 0.5rem !important;">
      ...
      <input id="idtest" type="text" class="form-control innm" name="review_id" value="${review.review_id}" readonly>      
	 </div>
    ...
    <div id="content" class="input-group mb-3" style="margin-bottom: 0.5rem !important;">
      ...
      <textarea class="form-control innm" rows="10" id="comment" name="review_content" style="background-color: white;  resize: none; " >${review.review_content}</textarea>      
    </div>  
    ...
    <div class="input-group mb-3">
      <div class="input-group-prepend">
        <span class="input-group-text">파일</span>
   			...
   			<input type="text" class="form-control innm" onclick="location.href='delReviewFile.do?review_num=${review.review_num}'" 
   			id="deletefile" value="${review.review_filename} [파일삭제]" style="cursor:pointer;" readonly>
