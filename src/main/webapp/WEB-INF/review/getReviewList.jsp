...
onerror="this.onerror=null; this.src='${pageContext.request.contextPath}/resources/img/cow.jpg';">
 </div>
 <div style="text-align: center;"> 
  	<table style="margin: 0 auto;">
  <tr ><td colspan="2" style="text-align:center; width:500px;"><h1>${review.review_title}</h1></td></tr>
